...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>Rooms with available beds</p>
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" Font-Size="Small">
        </asp:GridView>
    ...
    <p>Hospitalized patients without current diagnose or treatment</p>
        <asp:GridView ID="GridView2" runat="server" Font-Size="Small" DataSourceID="HospitalizedButNoDiagnose">
        </asp:GridView>
